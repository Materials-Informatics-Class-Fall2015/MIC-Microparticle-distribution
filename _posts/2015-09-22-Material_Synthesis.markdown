...
Glass microparticles were selected as they are relatively inexpensive, inert, non-toxic, and have a density difference large enough from CA to allow for CT imaging. Also importantly, they will not dissolve in NMP! The size of the particles was limited by the resolution of the micro CT imaging system (~5 µm) and a range of 9 to 22 µm particles was selected to ensure imaging would be possible. 
